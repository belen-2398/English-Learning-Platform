<template>
    ...
    <div class="short-line">
        <h1 class="pt-6 mb-4">Completed topics</h1>
    </div>
            ...
            <ul class="solid-border border-2 p-12">
                <li v-for="lesson in lessons" :key="lesson">
                    <div class="level-container">
                        <h3 class="bg-[var(--color-lightest)] w-1/2 mx-auto text-center text-4xl">{{ lesson.name }}</h3>
                        <ul class="grid grid-cols-3 gap-4">
                            <li v-for="topic in lesson.topics" :key="topic" class="list-line">
